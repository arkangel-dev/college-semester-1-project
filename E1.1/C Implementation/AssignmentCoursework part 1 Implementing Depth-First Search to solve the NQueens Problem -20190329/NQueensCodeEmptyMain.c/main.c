...
int main(int argc, const char * argv[])
{
	...
	*/
	...
	/*
		So this for loop will be loops as long as any one of the below conditions are 
		valid!
			> the number of vulnurable queens is zero
			> the number of placed queens is not 8
	*/
	{	
		...
		/*
			 ...
			 This condtion check's lines are executed if 
			 the number of vulnurable queens is zero and
			 there is no queen placed here...
			 
			 Its sort of a starter tile for each column...	
		*/
		{ 
			...
			columnCounter = 0; 
			AddQueenToNextRowInColumn(0); // <== I changed this to zero 
			CalculateNumberOfVulnerableQueensForWorkingCandidate();
		}
