...
int  train( double **trainingSamples, char *trainingLabels, int numSamples, int numFeatures)
{
    ...
    // first of all put all of the information in an array
    // then calculate the educlidian distance between the
    // corrosponding elements and input
    // find the index of data row that has the smallest euclidian distance
    // print out the data category...
